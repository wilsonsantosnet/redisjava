...
public class TestRedisPoolController {
    ...
    public String getAccount() {
        ...
        // RedisStandaloneConfiguration rediConfiguration = new RedisStandaloneConfiguration(cacheHostname, 6380);
        // redisStandaloneConfiguration.setPassword(cachekey);


        RedisClusterConfiguration rediConfiguration = new RedisClusterConfiguration();
        rediConfiguration.addClusterNode(new RedisNode(cacheHostname, 6380));
